...
class PdfReport:
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        #     os.path.abspath(self.filename), autoraise=True)
        result = webbrowser.open(self.filename, new=1, autoraise=True)
        print(result)


class FileSharer:
    def __init__(self, filepath, api_key="A2aGAGBUDQJGj84zis6Pzz"):
