...
canvas = Canvas(height=canvas_height, width=canvas_height,
                color=colors[canvas_color])

while True:
    shape_type = input("What do you like to draw? Enter quit to quit. ")

    # Ask for rectangle data and create rectange if user entered 'rectangle'
    ...
    # Ask for square data and create rectange if user entered 'square'
